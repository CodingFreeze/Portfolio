        ...
        <motion.h2 
          ...
          style={{
            ...
            <motion.p 
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              My technical toolkit spans from frontend and backend development to data science and DevOps. With 4+ years of coding experience across 10+ technologies and 20+ projects, I'm continuously learning to stay current with industry trends.
            </motion.p>
          </div>
                ...
                <div className="md:w-1/3 relative p-6 flex flex-col justify-between overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-[var(--muted)] mb-4">
                      Creating an interactive tool to visualize the Black-Scholes option pricing model, allowing users to adjust parameters and see real-time changes in option values.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2 mt-4 relative z-10">
                    <span className="px-2 py-1 text-xs rounded-md bg-[var(--bg)] text-[var(--muted)] hover:bg-[var(--accent)] hover:text-white transition-colors duration-200">JavaScript</span>
                    ...
                    <span className="px-2 py-1 text-xs rounded-md bg-[var(--bg)] text-[var(--muted)] hover:bg-[var(--accent)] hover:text-white transition-colors duration-200">Financial Modeling</span>
                  </div>
                </div>
                <div className="md:w-2/3 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium">Study Black-Scholes mathematical model</p>
                        <p className="text-sm text-[var(--muted)]">Researching option pricing theory and implementation approaches</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full bg-[var(--accent)] bg-opacity-50 flex items-center justify-center text-white mt-0.5">⟳</div>
                      <div>
                        <p className="font-medium">Design interactive UI and visualization components</p>
                        <p className="text-sm text-[var(--muted)]">Sketching user interface layouts and data visualization techniques</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium">Implement core calculation engine</p>
                        <p className="text-sm text-[var(--muted)]">Planning to build the mathematical model with input validation</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-[var(--accent)] border-opacity-10">
                    ...
                    <div className="relative pt-1">
                      <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-[var(--bg)]">
                        <div style={{ width: "20%" }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-[var(--accent)]"></div>
                      </div>
              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/3 relative p-6 flex flex-col justify-between overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-[var(--muted)] mb-4">
                      Developing a lightweight operating system for the MOS Technology 6502 microprocessor using Assembly and C, focusing on efficiency and minimalism.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2 mt-4 relative z-10">
                    <span className="px-2 py-1 text-xs rounded-md bg-[var(--bg)] text-[var(--muted)] hover:bg-[var(--accent)] hover:text-white transition-colors duration-200">Assembly</span>
                    <span className="px-2 py-1 text-xs rounded-md bg-[var(--bg)] text-[var(--muted)] hover:bg-[var(--accent)] hover:text-white transition-colors duration-200">C</span>
                    <span className="px-2 py-1 text-xs rounded-md bg-[var(--bg)] text-[var(--muted)] hover:bg-[var(--accent)] hover:text-white transition-colors duration-200">Systems Programming</span>
                  </div>
                </div>
                <div className="md:w-2/3 p-6">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-2">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full bg-[var(--accent)] flex items-center justify-center text-white mt-0.5">✓</div>
                      <div>
                        <p className="font-medium">Research 6502 architecture and limitations</p>
                        <p className="text-sm text-[var(--muted)]">Studying the processor's instruction set, memory management, and I/O capabilities</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full bg-[var(--accent)] bg-opacity-50 flex items-center justify-center text-white mt-0.5">⟳</div>
                      <div>
                        <p className="font-medium">Design kernel architecture and memory layout</p>
                        <p className="text-sm text-[var(--muted)]">Planning core OS components, memory allocation, and process management</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border border-dashed border-[var(--accent)] flex items-center justify-center text-[var(--accent)] mt-0.5">◯</div>
                      <div>
                        <p className="font-medium">Implement bootloader and basic I/O routines</p>
                        <p className="text-sm text-[var(--muted)]">Planning to write low-level system initialization and hardware interface code</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-[var(--accent)] border-opacity-10">
                    ...
                    <div className="relative pt-1">
                      <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-[var(--bg)]">
                        <div style={{ width: "15%" }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-[var(--accent)]"></div>
                      </div>
                      <div className="flex justify-between text-xs text-[var(--muted)]">
                        <span>Research</span>
                        <span>Design</span>
